...
from talent_matching import smart_hr_matcher
...
def main():
    ...
    # 실행할 기능 선택 (주석 처리된 항목은 실행되지 않음)
    run_hr_matcher = True  # smart_hr_matcher 실행 여부
    run_agent_graph = False  # supervisor_graph 실행 여부

    if run_hr_matcher:
        print("\n===== 🚀 Smart HR Matcher 실행 =====")
        smart_hr_matcher.main()
        return  # HR Matcher만 실행하고 종료
